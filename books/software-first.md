...
### リーンスタートアップ
- 市場調査で真のユーザーニーズを把握するのは困難。そこで，先にプロトタイプやモックアップを作り，少数のユーザーに試してもらいながら仮説検証を繰り返すやり方があり，リーン・スタートアップと呼ばれる。
- MVP：Minimum Viable Product，検証に必要な最小限の機能を持ったプロダクト。構築，計測，学習を繰り返す。
- デザインスプリント：5日間でアイデア形成〜プロトタイピングを行う方法
  - Day1：ユーザー理解。ユーザーインタビューやデータ分析を行い，プロダクトやサービスが解決すべき課題を洗い出す
  - Day2：発散。課題を解決するアイデアを出す。
  - Day3：決定。アイデアを取捨選択し，決定する
  - Day4：プロトタイプ。ユーザーが試せるプロトタイプを作ったり，紙とペンで搭載機能の見本を作る。
  - Day5：想定ユーザーにプロトタイプを触ってもらいながらユーザビリティのテストをする。これを受けて，課題やアイデアを再検討する。
- アンチ・リーンスタートアップ：大胆な計画，営業やマーケティングの重要性を説く。

### ユーザーを理解する
- ユーザーに生の声を聞くのではなく，ユーザーを観察する（デザイン思考）
- 